...
export  default  class TreeNode extends React.Component{
    ...
    render()
    {
        return (
                <svg>
                    <circle cx={this.state.cx} cy={this.state.cy} r="20" fill={this.state.color}></circle>
                    <text x={this.state.cx} y={this.state.cy+5} textAnchor="middle"  fill="black">{this.state.text}</text>
